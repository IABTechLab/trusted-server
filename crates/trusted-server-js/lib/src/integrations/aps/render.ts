...
var x=w.document;if(x.documentElement)x.documentElement.style.overflow="hidden";
if(x.body){x.body.style.margin="0";x.body.style.padding="0";x.body.style.overflow="hidden";}
