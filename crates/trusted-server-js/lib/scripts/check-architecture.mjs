...
const extensions = new Set(['.css', '.js', '.json', '.md', '.mjs', '.rs', '.sh', '.toml', '.ts', '.tsx', '.yaml', '.yml']);
...
forbid(
  legacySurfaceFiles,
  'legacy window runtime flag',
  new RegExp(oldRuntimePrefix, 'g'),
);
forbid(
  legacySurfaceFiles,
...
const requiredReplacements = [
  ...
  ['crates/trusted-server-js/lib/build-prebid-external.mjs', 'assertNoLegacyRuntimeFlags(finalBundle)'],
];
