...
impl LockrIntegration {
    ...
    async fn handle_api_proxy(
        ...
        // Extract path after /integrations/lockr/api
        ...
        // Map to actual Lockr API paths
        let target_path = match api_path {
            "/settings" => "/publisher/app/v1/identitylockr/settings",
            "/page-view" => "/publisher/app/v1/identitylockr/page-view",
            "/generate-tokens" => "/publisher/app/v1/identitylockr/generate-tokens",
            "/refresh-tokens" => "/publisher/app/v1/identitylockr/refresh-tokens",
            "/sync-no-hem-ids" => "/publisher/app/v1/identitylockr/sync-no-hem-ids",
            "/dataenrichment" => "/publisher/app/v1/identitylockr/dataenrichment",
            "/revoke-consent" => "/publisher/app/v1/identitylockr/revoke-consent",
            "/pending-token-request" => "/publisher/app/v1/identitylockr/pending-token-request",
            "/incorrect-data-found" => "/publisher/app/v1/identitylockr/incorrect-data-found",
            _ => {
                return Err(Report::new(Self::error(format!(
                    "Unknown Lockr API endpoint: {}",
                    api_path
                ))))
            }
        };
