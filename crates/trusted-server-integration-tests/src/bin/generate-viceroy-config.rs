...
fn generated_config_store_blocks(envelope_json: &str, edgezero_enabled: bool) -> String {
    ...
    format!(
        ...
        [local_server.config_stores.trusted_server_config.contents]
            ...
            edgezero_rollout_pct = "{edgezero_rollout_pct}""#
    )
}
...
mod tests {
    ...
    fn generated_config_contains_blob_and_rollout_flag() {
        ...
        assert!(
            generated.contains("edgezero_rollout_pct = \"100\""),
            "should include full rollout for enabled EdgeZero config"
        );
        assert!(
    ...
    fn generated_config_can_disable_edgezero() {
        ...
        assert!(
            generated.contains("edgezero_rollout_pct = \"0\""),
            "should include zero rollout for legacy config"
        );
    }
