    ...
    match route {
        ...
        ResponseRoute::BufferedUnmodified => {
            ...
            if is_processable_content_type(&content_type) && request_host.is_empty() {
                ...
                log::debug!(
                    "Skipping response processing - Content-Type: '{content_type}', status: {status}",
                );
            }
        ...
        ResponseRoute::Stream => {
            log::debug!(
                "Streaming response - Content-Type: {content_type}, Content-Encoding: {content_encoding}",
            );
        ...
        ResponseRoute::BufferedProcessed => {
            log::debug!(
                "Buffered response - Content-Type: {content_type}, Content-Encoding: {content_encoding}",
            );
