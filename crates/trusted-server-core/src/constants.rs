...
/// Host-only browser-session cookie activated by the ad trace console query.
pub const COOKIE_TS_CONSOLE: &str = "__Host-ts-console";
/// Reserved self-service query parameter for the ad trace console.
pub const QUERY_TS_CONSOLE: &str = "ts_console";
