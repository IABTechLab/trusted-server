...
- [ ] **Step 1: Write failing inline tests** (`mod explicit_path_tests`):
  ...
  2. Path with an excluded extension (`.png` — outside the [scanned-extensions list](../specs/2026-05-18-check-domains-design.md#file-extensions-scanned); `.html`/`.css` ARE scanned) → warns and skips, returns empty `Vec`.
