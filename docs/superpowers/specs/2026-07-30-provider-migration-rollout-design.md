...
| 24  | Malformed/absence-caused suppression clears on any newer valid grant (non-sticky); opt-out stickiness applies only to opt-out causes                                                                                                                     | permission §4.3                             | maintainers + legal   | open                                        |
