...
2. **Adapter qualification is a pre-ratification prerequisite, not a
   ...
   (`psl-snapshot-ref.md` now records the upstream commit, but the required
   ...
   GPP corpus and decoder** (`gpp-registry-snapshot.md` now records the
