...
| 31  | Replay-history capacity (16 semantic-state slots + a fixed saturation epoch with an epoch-pinned restrictive marker): while saturated, novel values cannot grant — fresh consent in unusual multi-CMP setups can be rejected until the epoch expires                                                                                                                                                                                                                                                                                                                                                                                                  | permission §4.3; providers wire schema      | —               | open                                                                                    |
