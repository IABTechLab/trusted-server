...
Creative processing is independent of provider routing. `sanitize_creatives`
is opt-in and strips executable markup. `rewrite_creatives` defaults to `true`
and rewrites eligible URLs through first-party endpoints.
