...
- That the *input data* (e.g., a partner-supplied UID) was accurate at the time of write. Signal accuracy remains the partner's responsibility.
...
```json
{
  ...
  "jwks": {
    "keys": [
      { "kty": "OKP", "crv": "Ed25519", "kid": "ts-2026-A", "use": "sig", "x": "..." }
    ]
  },
  "attestation": {
