/* prebid.js v10.10.0-pre
Updated: 2025-09-04
Modules: paapi, prebidServerBidAdapter, paapiForGpt, userId */
...
(self.pbjsChunk=self.pbjsChunk||[]).push([[606],{5161:(n,t,e)=>{e.d(t,{$:()=>u});var s=e(3006);const u=()=>function(n){const t=new WeakMap;return function(e){let s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};const u=n(e);if(null!=u)return t.has(u)||t.set(u,s),t.get(u)}}((n=>s.n.index.getAuction({auctionId:n})))}}]);
